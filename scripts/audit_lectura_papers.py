...
confundiendo:
  ...
  LEIDO_A_FONDO  tiene un informe en docs/s128/ que contesta las seis preguntas
                 (qué mide · qué criterio · nuestros frentes · en qué nos contradice ·
                 qué cita que no tenemos · qué NO dice)
  SINTETIZADO    aparece en BIBLIOGRAPHY_SYNTHESIS.md, que es de S13 (abril) y es
                 resumen, no lectura crítica. Cubre el "qué dice", casi nunca el
                 "en qué nos contradice"
  SIN_TOCAR      ni una cosa ni la otra
...
for est in ("LEIDO_A_FONDO", "SINTETIZADO", "SIN_TOCAR"):
