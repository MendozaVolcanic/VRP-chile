...
- **DISPLAY PCC/Villarrica** (§1 arranque S104 original, NO hecho): lacolito naranja +
  dedup mapa por celda/sensor. Display-only. Nicolás pidió dedup "por sensor" (cada
  sensor su escala/celda).
