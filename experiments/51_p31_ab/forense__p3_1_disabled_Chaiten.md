# Forense H17 replicable — Chaiten

Ventana: 2026-04-12 → 2026-04-25  ·  inner_radius_km=5.0  ·  tolerance_min=60

**N refs MIROVA (latest.php only)**: **0**

## Conteos

| Clase | Count | % | Significado |
|---|---:|---:|---|
| TP | 0 | 0.0% | Detectamos correctamente (summit o inner) |
...
| T4 | 0 | 0.0% | n_anomalous>0, todos far — D6 background no localizado |

**Recall summit-class (TP/N)**: 0.000