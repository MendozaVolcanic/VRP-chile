...
> Generado por `experiments/_s143_evaluador/control_s135.py` el 2026-09-18T05:38:35+00:00. Artefactos locales de los runs __run34173711390, __run34208191011 (no versionados, fuera del repo), fusionados en un directorio temporal: 18 archivos, 0 conflictos, 0 faltantes. Ventana 2026-06-01 a 2026-08-31, seis volcanes, brazos A, B y D. Ningún número de este documento está escrito a mano: todos salen de `control_s135.json`.
...
brazo: 12 noches, y el conjunto coincide exactamente con el publicado (NO).
...
| PlanchonPeteroa | 2026-07-24 | no | no | no |
| PlanchonPeteroa | 2026-08-09 | sí | no | no |
| PlanchonPeteroa | 2026-08-24 | no | no | no |
| Tupungatito | 2026-07-07 | sí | no | no |
| Tupungatito | 2026-08-01 | sí | no | no |

## Con la cota también en el brazo, el brazo D pierde más

Exigirle al brazo lo mismo que al control (hallazgo 2 del verificador) lleva las pérdidas de D de 12 a **21**, y las de B de 0 a **5**.
...
De esas 14 noches, **3** tienen el objeto del brazo a menos de 0,70 km de la
...
## El universo: 247 hoy contra las 260 publicadas

El evaluador nuevo cuenta **247** noches confirmadas; S135 publicó **260**. La
...
| Isluga | 73 | 71 | 71 | 71 |
| Lascar | 50 | 52 | 52 | 52 |
| Lastarria | 42 | 48 | 48 | 48 |
| PuyehueCordonCaulle | 31 | 31 | 33 | 33 |
| PlanchonPeteroa | 24 | 28 | 28 | 28 |
