...
> número más alto: `ls tasks/BLOQUE_ARRANQUE_S*.md | sort -V | tail -1` (al 2026-09-19,
> `tasks/BLOQUE_ARRANQUE_S144.md`). Ese orden de lectura lo declara el `CLAUDE.md` del proyecto.
