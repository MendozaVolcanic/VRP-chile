...
- **Estado**: abierta (S141, 2026-09-15). Estrato nevado sin candidatos: otra ventana del OSF o reusar pasadas del v1 queda como decisión de Nicolás.
- **Resolución**: pendiente de corrida.
